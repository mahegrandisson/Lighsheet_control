...
class NMM(QObject):
    ...
    def __init__(self,config: str=r"C:\Program Files\Micro-Manager-2.0\PVCam\MMConfig_demo.cfg",exposure:int = 10):
        super().__init__()
    ...
    def showDevices(self):
        print("CAMERA=",self.core.getCameraDevice())
        print("SLM=",self.core.getSLMDevice())

    def set_galvos_position(self,value:float,galvo_id: int):
        """
        ...
        if galvo_id in [1,2]:
            if galvo_id==1:
                task.CreateAOVoltageChan("Dev1/ao0", "", value, value + 0.01, PyDAQmx.DAQmx_Val_Volts, None)
            else :
                task.CreateAOVoltageChan("Dev1/ao1", "", value, value + 0.01, PyDAQmx.DAQmx_Val_Volts, None)
        else:
    ...
    def scan_between_galvos(self,start1, end1, start2, end2, steps,folder = "TEST"):
        """
...
if __name__=="__main__":
    ...
    nmm.scan_between_galvos(-0.03,0.03,-2,2,10)
    #nmm.test()