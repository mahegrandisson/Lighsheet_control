...
taskCAM.CfgImplicitTiming(PyDAQmx.DAQmx_Val_ContSamps, 1)
...
taskG.CfgSampClkTiming("/Dev1/PFI12", sample_rate, PyDAQmx.DAQmx_Val_Rising,PyDAQmx.DAQmx_Val_ContSamps, samples_per_period)


task_ms = Task()
task_ms.CreateCOPulseChanTime("/Dev1/ctr0", "", PyDAQmx.DAQmx_Val_Seconds, PyDAQmx.DAQmx_Val_Low, 0, time_per_period/(2*samples_per_period), time_per_period/(2*samples_per_period))
task_ms.CfgImplicitTiming(PyDAQmx.DAQmx_Val_ContSamps, 1)
print(wave_2.shape)
taskG.WriteAnalogF64(len(wave_2), False, 10.0, PyDAQmx.DAQmx_Val_GroupByChannel, wave_2, None,
                     None)
